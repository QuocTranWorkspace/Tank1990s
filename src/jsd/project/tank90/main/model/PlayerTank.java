...
public class PlayerTank extends BaseTank {
     ...
     */
    public static final Image shieldImage = new ImageIcon(Objects.requireNonNull(PlayerTank.class.getResource("../../common/resources/img/player/shield.png"))).getImage();
    /**
     * The constant invincibleImage1.
     */
    public static final Image invincibleImage1 = new ImageIcon(Objects.requireNonNull(PlayerTank.class.getResource("../../common/resources/img/player/invincible_1.png"))).getImage();
    /**
     * The constant invincibleImage2.
     */
    public static final Image invincibleImage2 = new ImageIcon(Objects.requireNonNull(PlayerTank.class.getResource("../../common/resources/img/player/invincible_2.png"))).getImage();
    ...
    public PlayerTank(Point2D position) {
        ...
        this.tier = 1;
        this.setImage(new ImageIcon(Objects.requireNonNull(getClass().getResource("../../common/resources/img/player/player_up_1.png"))).getImage());
    ...
    private void changeImage(String image) {
        ...
        String imagePath = "../../common/resources/img/player/";
    ...
    public void respawn() {
        this.direction = Directions.UP;
        this.position = new Point2D((int) (10 * Main.FRAME_HEIGHT / 27.9), (int) (25 * Main.FRAME_HEIGHT / 27.9));
        this.tier = 1;
        this.setInvincible(true);
        Timer timer = new Timer(3000, ev -> this.setInvincible(false));
        timer.setRepeats(false);
